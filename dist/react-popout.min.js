...
/***/ function(module, exports, __webpack_require__) {
	...
	var PopoutWindow = function (_React$Component) {
	  ...
	  function PopoutWindow(props) {
	    ...
	    _this.setState({ scripts: _this.parse(props) });
	    return _this;
	  }
	  ...
	  _createClass(PopoutWindow, [{
	    ...
	    key: 'findScritps',
	    value: function (_findScritps) {
	      function findScritps(_x) {
	        return _findScritps.apply(this, arguments);
	      }

	      findScritps.toString = function () {
	        return _findScritps.toString();
	      };
